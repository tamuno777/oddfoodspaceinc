...
const InternationalCusines = () => {
  ...
  if (dishes.length === 0) {
    return (
      <p className="text-center text-lg font-semibold">
        No Intercontinental dishes found.
      </p>
    );
  }
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-3xl font-bold text-center mb-8">Intercontinental Dishes</h1>
...
export default InternationalCusines;
